...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var chatbotKB = {
    ...
    volunteer: {
      triggers: {
        ...
        partial: ['volunteer', 'help out', 'give time', 'get involved', 'assist', 'contribute time', 'sign up', 'lend a hand', 'marathon', 'challenge', 'raffle'],
        keywords: ['volunteer', 'help', 'involved', 'participate', 'join', 'assist', 'sign', 'marathon', 'challenge']
      },
      responses: [
        'We\'d absolutely love to have you involved! There are lots of ways to help: <strong>volunteer</strong> at our events, <strong>run a mini marathon</strong> for CROSS, <strong>take on a personal challenge</strong> (a sponsored cycle, swim, or climb), <strong>host a fundraising event</strong> in your community, <strong>spread awareness</strong> on social media, or explore <strong>corporate sponsorship</strong> opportunities. Just fill out our <a href="#contact" style="color: var(--color-accent); font-weight: 600;">contact form</a> and someone from the team will be in touch to chat about how you can get involved.',
        'That\'s brilliant \u2014 thank you! Whether you can spare a few hours for an event or want to take on something bigger, we\'d love your help. You could assist at our events, run a mini marathon, take on a personal challenge like a sponsored cycle or swim, host a community fundraiser, help with social media, or simply spread the word. <a href="#contact" style="color: var(--color-accent); font-weight: 600;">Drop us a message</a> and we\'ll find the perfect fit for you.',
        'Getting involved with CROSS is one of the best ways to make a tangible difference for cancer research in Ireland. Our volunteers are the backbone of everything we do. You could run a mini marathon, take on a personal challenge, volunteer at events, host a fundraiser, or help spread the word. If you\'re interested, <a href="#contact" style="color: var(--color-accent); font-weight: 600;">reach out through our contact form</a> and a team member will chat with you about what suits your interests and availability.'
      ],
  ...
  var committeeSignals = ['committee', 'board', 'member', 'chair', 'leadership', 'team', 'james', 'john', 'sean', 'conor', 'patrick', 'jacqueline', 'luca', 'ben', 'philip', 'wallace', 'reynolds', 'headon', 'patron'];
