  ...
  var chatbotKB = {
    ...
    research: {
      triggers: {
        ...
        partial: ['research', 'science', 'lab', 'laborator', 'stud', 'cancer', 'equipment', 'machine', 'cryostat', 'pcr', 'cytometer', 'microarray', 'translational', 'clinical', 'finding', 'cure', 'seahorse', 'gelcount', 'gene scanner', 'quantstudio', 'testimonial', 'quote', 'hypoxia', 'nanox', 'biobank', 'freezer', 'oxygen', 'ó murchú', 'maitiu', 'raquel', 'santamaria', 'erin', 'kindlon', 'researcher'],
