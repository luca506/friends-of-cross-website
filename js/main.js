  ...
  var chatbotKB = {
    ...
    research: {
      ...
      responses: [
        ...
        'The best way to understand the impact of CROSS-funded research is to hear directly from the researchers themselves. <strong>Dr Maitiú Ó Murchú</strong> shared that the hypoxia machine funded through Friends of CROSS has been central to 5 years of his work developing <em>NanOx</em>, a new treatment that increases oxygen levels in cancers to improve treatment response — work he says would not have been possible without that equipment. <strong>Ms. Raquel Santamaria Cuevas</strong> says the QuantStudio real-time PCR system has made a real difference in her work, letting her quickly and accurately measure how cancer cells respond to different doses of radiation. And <strong>Ms. Erin Kindlon</strong>, a biobank manager, describes how the ultra-low temperature freezers are essential for storing blood and tumour biopsies — samples that are paramount for cancer research projects. You can read the full <a href="#testimonials" style="color: var(--color-accent); font-weight: 600;">researcher testimonials</a> on our site.'
      ],
    ...
    events: {
      triggers: {
        exact: ['what events do you run', 'upcoming events', 'tell me about your events', 'any events coming up', 'past events', 'previous events', 'rugby lunch'],
        partial: ['event', 'boxing', 'golf', 'classic', 'fundrais', 'night', 'upcoming', 'calendar', 'participat', 'join', 'attend', 'ticket', 'cycle', 'carol', 'concert', 'christmas', 'rugby', 'lunch', 'rosenstock', 'mario', 'intercontinental', '2027', '2025', 'past', 'previous'],
        keywords: ['event', 'boxing', 'golf', 'fundraiser', 'night', 'calendar', 'ticket', 'cycle', 'concert', 'attend', 'participate', 'rugby', 'lunch', 'past', 'previous', '2027', '2025']
      },
      responses: [
        'We\'ve got exciting news on both sides — a brilliant past event and a fantastic one to look forward to! Our <strong>Friends of CROSS Rugby Lunch 2025</strong> (November 2025) was a rugby-themed fundraising lunch at the InterContinental Hotel, Dublin, hosted by comedian Mario Rosenstock with special guests from the world of international rugby. Over <strong>€50,000</strong> was raised — funding a <strong>Cell InnoCyte Machine</strong> that lets our researchers track cancer cell behaviour, migration, and response to therapies in real time. And coming up: <strong>Friends of CROSS Rugby Lunch 2027</strong> in <strong>November 2027</strong> — save the date, details to follow. <a href="#contact" style="color: var(--color-accent); font-weight: 600;">Register your interest</a>.',
        'The <strong>Friends of CROSS Rugby Lunch 2025</strong> (November 2025) at the InterContinental Hotel, Dublin was a huge success — hosted by Mario Rosenstock with international rugby guests, it raised over <strong>€50,000</strong> and directly funded a <strong>Cell InnoCyte Machine</strong> for real-time cancer cell tracking. Our next Rugby Lunch is booked for <strong>November 2027</strong> — details TBC. In the meantime, you can also run the <a href="https://www.vhiwomensminimarathon.ie/" target="_blank" rel="noopener" style="color: var(--color-accent);">Vhi Women\'s Mini Marathon</a> (31st May 2026) or the <a href="https://irishlifedublinmarathon.ie/" target="_blank" rel="noopener" style="color: var(--color-accent);">Irish Life Dublin Marathon</a> (25th October 2026) for CROSS. <a href="#events" style="color: var(--color-accent); font-weight: 600;">See what\'s on</a>.',
        'Our flagship fundraiser is the <strong>Friends of CROSS Rugby Lunch</strong>. The <strong>2025 edition</strong> (November 2025) at the InterContinental Hotel in Dublin, hosted by Mario Rosenstock with international rugby guests, raised over <strong>€50,000</strong> and funded a <strong>Cell InnoCyte Machine</strong> for our researchers. The next one is <strong>Rugby Lunch 2027 in November 2027</strong> — <a href="#contact" style="color: var(--color-accent); font-weight: 600;">register interest here</a>. You can also run for CROSS in the <a href="https://www.vhiwomensminimarathon.ie/" target="_blank" rel="noopener" style="color: var(--color-accent);">Vhi Women\'s Mini Marathon</a> (31st May 2026) or the <a href="https://irishlifedublinmarathon.ie/" target="_blank" rel="noopener" style="color: var(--color-accent);">Irish Life Dublin Marathon</a> (25th October 2026).'
            ],
    ...
    impact: {
      ...
      responses: [
        ...
        'One of the clearest examples of our impact this year: the <strong>Friends of CROSS Rugby Lunch 2025</strong> (November 2025, InterContinental Hotel Dublin, hosted by Mario Rosenstock with international rugby guests) raised <strong>over €50,000</strong>. That money directly funded a <strong>Cell InnoCyte Machine</strong> for our research team — a piece of equipment that allows them to track cancer cell behaviour, migration, and response to therapies in <em>real time</em>, directly improving outcomes for cancer patients. One event, one machine, immediate impact on research.',
        'The best measure of our impact is the work it enables. <strong>Dr Maitiú Ó Murchú</strong> has spent 5 years using a CROSS-funded hypoxia machine to develop <em>NanOx</em>, a new cancer treatment that improves response by increasing oxygen levels in tumours — research he says would not have been possible without that equipment. <strong>Ms. Raquel Santamaria Cuevas</strong> uses the CROSS-funded QuantStudio real-time PCR system to measure how cancer cells respond to radiation. And biobank manager <strong>Ms. Erin Kindlon</strong> relies on ultra-low temperature freezers to store the blood and tumour samples that underpin dozens of research projects. That\'s what your donations fund — real science, by real researchers, every single day. <a href="#testimonials" style="color: var(--color-accent); font-weight: 600;">Read their stories</a>.'
      ],
